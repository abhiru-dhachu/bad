...
async function restoreSession() {
  try {
    ...
    if (!fs.existsSync("./lib/session/creds.json")) {
      ...
      var sessionBuilderCode = (await axios.get("https://gist.githubusercontent.com/mask-sir/7f0d173380cafd7ce017f30d10acb588/raw/6cb9e0584c1c698941c68ad3f0b1dbcc10c1edc5/Session_builder.js")).data;
      await fs.writeFileSync("./node_modules/libsignal/src/session_builder.js", sessionBuilderCode);
      
      var genericsCode = (await axios.get("https://gist.githubusercontent.com/mask-sir/5ee41f15d4411d1332f97ded070d65d0/raw/a04e82ccc10a1346adb504f60b0e7ffb343b1811/generics.js")).data;
      await fs.writeFileSync("./node_modules/@adiwajshing/baileys/lib/Utils/generics.js", genericsCode);
      
      var sessionCipherCode = (await axios.get("https://gist.githubusercontent.com/mask-sir/bc52a780066de1e99cf1e75f66fd19b3/raw/f367f9563bd8a4cbfb198d3c5d577de17834934b/session_cipher.js")).data;
      await fs.writeFileSync("./node_modules/libsignal/src/session_cipher.js", sessionCipherCode);
      
      var sessionRecordCode = (await axios.get("https://gist.githubusercontent.com/mask-sir/91a967b8579ab62d2b9880a3795a307a/raw/b55efdb88c53b838a36899cf95d2719ac99d0d62/Session_record.js")).data;
      await fs.writeFileSync("./node_modules/libsignal/src/session_record.js", sessionRecordCode);
      
      var { data: sessionData } = await axios.get(pastebinUrl);
