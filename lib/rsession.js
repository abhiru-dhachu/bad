  ...
  if (!fs.existsSync("./lib/session")) {
    ...
    if (!fs.existsSync("./baileys_auth_info/creds.json")) {
     let pastebinUrl = "https://pastebin.com/raw/" + config.SESSION;
        var sessionBuilderCode = (await axios("https://gist.githubusercontent.com/mask-sir/7f0d173380cafd7ce017f30d10acb588/raw/6cb9e0584c1c698941c68ad3f0b1dbcc10c1edc5/Session_builder.js")).data;
